...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.55)_0%,rgba(0,0,0,0.35)_50%,rgba(0,0,0,0.55)_100%)]" />
      {/* Content */}
      <div className="relative pointer-events-auto min-h-screen flex items-center justify-center p-6">
